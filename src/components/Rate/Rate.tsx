...
const Rate: React.FC<IRateProps> = ({numberOfStars, value, setValue}) => {
    const divRef = useRef<HTMLDivElement>(null)
    const [stars] = useState(new Array(numberOfStars).fill(0))
